		...
		ta:[
			'<div id="' + this.calendarId + '" class="ta_calendar ta_calendar2 cf">',
				...
				'<div class="ta_calendar_footer cf" '+ (this.mOpts.autoSubmit ? ' style="display:none" ' : '') +'>',
					...
					'</div>',
					'<div class="frm_btn">',
						'<input class="ta_btn ta_btn_primary" type="button" name="' + this.submitBtn + '" id="' + this.submitBtn + '" value="确定" style="width: 86px;"/>',
						'<input class="ta_btn" type="button" id="' + this.closeBtn + '" value="取消" style="width: 86px;"/>',
					'</div>',
				'</div>',
			'</div>'
		]
