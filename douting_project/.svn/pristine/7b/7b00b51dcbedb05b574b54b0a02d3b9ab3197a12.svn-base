        ...
        if(responseObject.getCode()==0&&responseObject.getData()!=null&&responseObject.getData()!=""){
        	...
        	if(temp>0){
        		...
        		if(param.get("contentName")!=null){
        			doRewardDetail.put("contentName", param.get("contentName"));
        		}
        		...
        		doRewardDetail.put("gainerId", param.get("beRewardId"));
        		doRewardDetail.put("gainerName", param.get("beRewardName"));
        		doRewardDetail.put("type", param.get("doRewardType"));
        		doRewardDetail.put("phone", param.get("phone"));
        		doRewardDetail.put("expenditureType", "reward");
        		//被打赏者  目前是 栏目和直播间 
        		...
        		beRewardDetail.put("expenditureType", "reward");
